        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                {{-- <div class="card-footer text-end">
                    <a href="{{ route('dashboard.medicinetype.index') }}"><button class="btn btn-primary"
                            type="submit">Назад</button></a>
                </div> --}}
                <form action="{{ route('dashboard.medicinetype.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($medicinetypes as $key => $medicinetype)
                                <tr>
                                    <th scope="row">{{ ++$key }}</th>
                                    <td>{{ $medicinetype->name }}</td>
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $medicinetype->id }}Edit"><i
                                                class="bx bx-pencil"></i>Изменить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $medicinetype->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.medicinetype.update', $medicinetype) }}"
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $medicinetype->id }}"><i
                                                class="bx bx-trash"></i>Удалить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $medicinetype->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.medicinetype.destroy', $medicinetype->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
