        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                {{-- <div class="card-footer text-end">
                    <a href="{{ route('dashboard.representative.index') }}"><button class="btn btn-primary"
                            type="submit">Назад</button></a>
                </div> --}}
                <form action="{{ route('dashboard.representative.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($representatives as $key => $representative)
                                <tr>
                                    ...
                                    <td>{{ $representative->link }}</td>
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $representative->id }}Edit"><i
                                                class="bx bx-pencil"></i>Изменить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $representative->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.representative.update', $representative) }}"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" for="link">Ссылки</label>
                                                                                <input class="form-control" id="link" type="text" name="link" value="{{ $representative->link }}"
                                                                                    >
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $representative->id }}"><i
                                                class="bx bx-trash"></i>Удалить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $representative->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.representative.destroy', $representative->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
