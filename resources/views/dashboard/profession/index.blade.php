        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                {{-- <div class="card-footer text-end">
                    <a href="{{ route('dashboard.profession.index') }}"><button class="btn btn-primary"
                            type="submit">Назад</button></a>
                </div> --}}
                <form action="{{ route('dashboard.profession.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $profession->id }}Edit"><i
                                                class="bx bx-pencil"></i>Изменить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $profession->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.profession.update', $profession) }}"
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $profession->id }}"><i
                                                class="bx bx-trash"></i>Удалить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $profession->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.profession.destroy', $profession->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
