        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                {{-- <div class="card-footer text-end">
                    <a href="{{ route('dashboard.organizationtype.index') }}"><button class="btn btn-primary"
                            type="submit">Назад</button></a>
                </div> --}}
                <form action="{{ route('dashboard.organizationtype.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $organizationtype->id }}Edit"><i
                                                class="bx bx-pencil"></i>Изменить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $organizationtype->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.organizationtype.update', $organizationtype) }}"
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input class="form-control"
                                                                                    ...
                                                                                    type="text" name="name"
                                                                                    value="{{ $organizationtype->name }}" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $organizationtype->id }}"><i
                                                class="bx bx-trash"></i>Удалить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $organizationtype->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('dashboard.organizationtype.destroy', $organizationtype->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
